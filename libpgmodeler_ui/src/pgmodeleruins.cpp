...
namespace PgModelerUiNS {
	...
	NumberedTextEditor *createNumberedTextEditor(QWidget *parent, bool allow_ext_files)
	{
		NumberedTextEditor *editor=new NumberedTextEditor(parent, allow_ext_files);
